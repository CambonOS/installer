...
if [[ $GPU = vmware ]]
then echo "echo 'trizen --noconfirm -Sy virtualbox-guest-utils || exit 1' | su $USER || exit 1" | ARCH && echo "echo yes | rcvboxadd setup; /sbin/rcvboxadd quicksetup all" && DONE || ERROR
