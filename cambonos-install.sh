...
then
	echo -e "\n>>Instalando Qtile\c"
	echo 'echo "cd /tmp; git clone -b python https://github.com/ManuCr19/qtile && cd qtile && phyton3 install.py" | su $USER' | ARCH && DONE || ERROR
fi
...
echo "echo 'yay --noconfirm -Sy neofetch zsh zsh-completions zsh-autosuggestions zsh-syntax-highlighting zsh-theme-powerlevel10k zsh-sudo-git ttf-meslo-nerd-font-powerlevel10k xdg-user-dirs zramd || exit 1' | su $USER || exit 1" | ARCH
