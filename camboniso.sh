...
echo -e "chown root:root /ISO/porfile/airootfs/usr/local/bin/camboninstall\nchmod 755 /ISO/porfile/airootfs/usr/local/bin/camboninstall" >>/ISO/porfile/airootfs/root/.zshrc
